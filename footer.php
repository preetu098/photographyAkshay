<footer id="footer">
		...
		<div class="container">
			<div class='column dt-sc-one-fourth first'>
				<aside id="text-2" class="widget widget_text">
					<div class="textwidget">
						<p>Welcome to SoulFul Photography Academy</p>
						
						<div class="dt-sc-hr-invisible-xsmall "></div>
						<p>STAY CONNECTED</p>
						<div class="dt-sc-hr-invisible-xxsmall "></div>
						<ul class='dt-sc-sociable rounded-border '>
							<li><a class="fa fa-instagram" target="_blank" href="https://www.instagram.com/soulfulphotoacademy/" rel="noopener"></a></li>
							<li><a class="fa fa-dribbble" target="_blank" href="#" rel="noopener"></a></li>
							<li><a class="fa fa-facebook" target="_blank" href="https://www.facebook.com/SoulFulPhotographyAcademy/" rel="noopener"></a></li>
			...
			<div class='column dt-sc-one-half '>
				<aside id="text-3" class="widget widget_text">
					<img src="https://www.transparentpng.com/thumb/camera-logo/camera-optics-design-images-Y8uSyy.png" class="img-fluid" alt="">
					<div class="textwidget">
			...
			<div class='column dt-sc-one-fourth '>
				<aside id="text-4" class="widget widget_text">
					...
					<div class="textwidget">
						<!-- <div class="dt-sc-contact-info"><span class="fa fa-home"></span>72 Pilgrim Avenue, Chevy
							Chase,<br />
							MD 20815</div> -->
						<div class="dt-sc-hr-invisible-xsmall"></div>
						<!-- <div class="dt-sc-contact-info"><span class="fa fa-phone"></span>(226) 906-2721<br />
							(671) 925-1352</div> -->
						<div class="dt-sc-hr-invisible-xsmall "></div>
						<!-- <div class="dt-sc-contact-info"><span class="fa fa-paper-plane-o"></span><a href="#">
								info@dance.com</a></div> -->
					</div>
				</aside>
			</div>
		</div>
	...
	<div class="footer-copyright dt-sc-dark-bg">
		<div class="container">
			...
			<div class="column dt-sc-one-third aligncenter ">Copyright &copy; 2023. All rights reserved by, <a
					href="http://themeforest.net/user/designthemes">ModernTech</a> </div>
...
<link rel='stylesheet' id='vc_google_fonts_roboto_condensed300300italicregularitalic700700italic-css'
	href='//fonts.googleapis.com/css?family=Roboto+Condensed%3A300%2C300italic%2Cregular%2Citalic%2C700%2C700italic&#038;ver=6.1.1'
	type='text/css' media='all' />
<script type='text/javascript'
